...
# GenePattern Notebook Technical Documentation
...
This is the technical documentation for g2nb. For all the documentation go [here](http://website.genepattern.org/docs)

### What is g2nb?

The [**g2nb**](http://notebook.genepattern.org) environment integrates analysis platforms with the Jupyter Notebook system, allowing researchers to create documents that interleave formatted text, graphics and other multimedia, executable code, and GenePattern analyses, creating a single "research narrative" that puts scientific discussion and analyses in the same place.
...
- [**GenePattern Notebook Homepage**](https://notebook.genepattern.org)
